    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolesAbilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RolesAbilities_Abilities_AbilityId",
                        column: x => x.AbilityId,
                        principalTable: "Abilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolesAbilities_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MissionDoubleUpAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    AdvanceInstallmentAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollPayouts_Employees_CreatedByEmployeeId",
                        column: x => x.CreatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollPayouts_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenderInsuranceAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TenderTaxAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SupplyProfitMargin = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AmountCash = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierPayments_Employees_CreatedByEmployeeId",
                        column: x => x.CreatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualSpent = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    ForemanEmployeeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Missions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Missions_Employees_ForemanEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectAttachments_Employees_UploadedByEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectAudits_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectExpenses_Employees_CreatedByEmployeeId",
                        column: x => x.CreatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectPayments_Employees_CreatedByEmployeeId",
                        column: x => x.CreatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockMovements_Employees_CreatedByEmployeeId",
                        column: x => x.CreatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissionWorkers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MissionWorkers_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MissionWorkers_Missions_MissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<int>(type: "int", nullable: true),
                    SupplierId = table.Column<int>(type: "int", nullable: true),
                    ProjectExpenseId = table.Column<int>(type: "int", nullable: true),
                    MissionId = table.Column<int>(type: "int", nullable: true),
                    PayrollPayoutId = table.Column<int>(type: "int", nullable: true),
                    CreatedByEmployeeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CashBoxTransactions_Employees_CreatedByEmployeeId",
                        column: x => x.CreatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CashBoxTransactions_Missions_MissionId",
                        column: x => x.MissionId,
                        principalTable: "Missions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CashBoxTransactions_PayrollPayouts_PayrollPayoutId",
                        column: x => x.PayrollPayoutId,
                        principalTable: "PayrollPayouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CashBoxTransactions_ProjectExpenses_ProjectExpenseId",
                        column: x => x.ProjectExpenseId,
                        principalTable: "ProjectExpenses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CashBoxTransactions_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CashBoxTransactions_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashBoxTransactions_CreatedByEmployeeId",
                table: "CashBoxTransactions",
                column: "CreatedByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_CashBoxTransactions_MissionId",
                table: "CashBoxTransactions",
                column: "MissionId");

            migrationBuilder.CreateIndex(
                name: "IX_CashBoxTransactions_PayrollPayoutId",
                table: "CashBoxTransactions",
                column: "PayrollPayoutId");

            migrationBuilder.CreateIndex(
                name: "IX_CashBoxTransactions_ProjectExpenseId",
                table: "CashBoxTransactions",
                column: "ProjectExpenseId");

            migrationBuilder.CreateIndex(
                name: "IX_CashBoxTransactions_ProjectId",
                table: "CashBoxTransactions",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_CashBoxTransactions_SupplierId",
                table: "CashBoxTransactions",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Missions_ForemanEmployeeId",
                table: "Missions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissionWorkers_EmployeeId",
                table: "MissionWorkers",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_MissionWorkers_MissionId",
                table: "MissionWorkers",
                column: "MissionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollPayouts_CreatedByEmployeeId",
                table: "PayrollPayouts",
                column: "CreatedByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_PayrollPayouts_EmployeeId",
                table: "PayrollPayouts",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectAttachments_UploadedByEmployeeId",
                table: "ProjectAttachments",
                column: "UploadedByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectAudits_EmployeeId",
                table: "ProjectAudits",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectExpenses_CreatedByEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectPayments_CreatedByEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolesAbilities_AbilityId",
                table: "RolesAbilities",
                column: "AbilityId");

            migrationBuilder.CreateIndex(
                name: "IX_RolesAbilities_RoleId",
                table: "RolesAbilities",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_CreatedByEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierPayments_CreatedByEmployeeId",
